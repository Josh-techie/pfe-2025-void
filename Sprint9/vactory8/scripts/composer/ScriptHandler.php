...
//    }
  ...
  public static function checkComposerVersion(Event $event) {
    ...
    if (Comparator::lessThan($version, '2.0.9')) {
      $io->writeError('<error>Vactory requires Composer version greater than or equal 2.0.9. Please update your Composer before continuing</error>.');
      exit(1);
    }
  }
}
