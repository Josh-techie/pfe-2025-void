 ...
 */
//$settings['trusted_host_patterns'] = [ '[0-9a-z]*\.lapreprod\.com' ];
/**
...
/**
 * Redirects being built as http://vactory8.lapreprod.com/current
 * and not considered safe by RedirectResponseSubscriber When using Capistrano
 *
 * @see https://www.drupal.org/project/drupal/issues/2612160#comment-11767977
 */
if (
  isset($GLOBALS['request']) and
  '/current/index.php' === $GLOBALS['request']->server->get('SCRIPT_NAME')
) {
...
// Env.
$vactory_environment = 'production';
...
// XML settings.
$config['xmlsitemap.settings']['xsl'] = FALSE;
...
// By default exclude dev modules configurations from being exported/imported.
...
/**
 * Entity Autocomplete Exact Matcher characters.
 *
 * Example:
 * $settings['entity_autocomplete_exact_matcher']['opener'] = '{';
