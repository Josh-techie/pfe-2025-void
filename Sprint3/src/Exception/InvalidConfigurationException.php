 ...
 */
 ...
 class InvalidConfigurationException extends \UnkownOptionException implements ConfigurationExceptionInterface
 {
        /**
     ...
     */
    public static function forConfiguration(string $option, $valueGiven, ?sting $description = null):self{
